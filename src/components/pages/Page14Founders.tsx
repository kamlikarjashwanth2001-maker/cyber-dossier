...
export function Page14Founders({ goToIndex }: { goToIndex?: (i: number) => void }) {
  return (
    <div className="relative w-full h-full bg-void overflow-hidden flex flex-col p-8 md:p-12">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col h-full">
        ...
        <div className="flex-none flex items-end justify-between mb-8">
          <div>
            ...
            <motion.h2
              ...
              viewport={{ once: true }}
              className="display text-4xl md:text-5xl lg:text-6xl font-semibold text-paper tracking-tight leading-[1.1]"
            >
        ...
        {/* Founder Profiles - Flex-1 to fill remaining height tightly */}
        <div className="flex-1 flex flex-col gap-6 min-h-0">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex-1 glass bg-void/80 backdrop-blur-md border border-cyan/20 p-6 flex items-stretch gap-8 hover:border-cyan/40 transition-colors"
          >
            {/* Image */}
            <div className="w-48 xl:w-64 flex-shrink-0 relative overflow-hidden border border-line/30 h-full">
              <img src={akhilImg} alt="Akhil Gabbeta" className="absolute inset-0 w-full h-full object-cover object-top grayscale hover:grayscale-0 transition-all duration-700" />
            ...
            <div className="flex-1 flex flex-col justify-center min-w-0">
              ...
              <p className="mono text-[10px] text-cyan uppercase tracking-[0.1em] mb-4 truncate">Founder & CEO, Hackers In Threat Hunt</p>
              
              <div className="text-paper/80 text-xs xl:text-sm leading-relaxed space-y-3 mb-6 flex-1 overflow-hidden">
          ...
          >
            {/* Image */}
            <div className="w-48 xl:w-64 flex-shrink-0 relative overflow-hidden border border-line/30 h-full">
              <img src={nikhilaImg} alt="Nikhila Abbarla" className="absolute inset-0 w-full h-full object-cover object-top grayscale hover:grayscale-0 transition-all duration-700" />
              <div className="absolute inset-0 bg-cyan/10 mix-blend-overlay pointer-events-none" />
              <div className="absolute top-0 left-0 w-3 h-3 border-t border-l border-cyan/50" />
              <div className="absolute bottom-0 right-0 w-3 h-3 border-b border-r border-cyan/50" />
            </div>
            ...
            <div className="flex-1 flex flex-col justify-center min-w-0">
              ...
              <p className="mono text-[10px] text-cyan uppercase tracking-[0.1em] mb-4 truncate">Co-Founder & Chief Business Officer</p>
              
              <div className="text-paper/80 text-xs xl:text-sm leading-relaxed space-y-2 mb-6 flex-1 overflow-hidden">
